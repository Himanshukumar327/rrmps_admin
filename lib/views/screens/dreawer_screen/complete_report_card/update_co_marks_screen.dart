...
class UpdateCoSchMarksScreen extends StatefulWidget {
  const UpdateCoSchMarksScreen({super.key});

  @override
  UpdateCoSchMarksScreenState createState() => UpdateCoSchMarksScreenState();
}

class UpdateCoSchMarksScreenState extends State<UpdateCoSchMarksScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Update Co-Sch Marks",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),)),
      body: Padding(
