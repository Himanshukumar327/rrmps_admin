...
class AddLKGUKGMarksScreen extends StatefulWidget {
  const AddLKGUKGMarksScreen({super.key});

  @override
  AddLKGUKGMarksScreenState createState() => AddLKGUKGMarksScreenState();
}

class AddLKGUKGMarksScreenState extends State<AddLKGUKGMarksScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Add LKG&UKG Marks",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),)),
      body: Padding(
