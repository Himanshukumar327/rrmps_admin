...
class ReportMarksListScreen extends StatefulWidget {
  const ReportMarksListScreen({super.key});

  @override
  ReportMarksListScreenState createState() => ReportMarksListScreenState();
}

class ReportMarksListScreenState extends State<ReportMarksListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Report Marks List Screen",style: TextStyle(color: Colors.blueAccent,
