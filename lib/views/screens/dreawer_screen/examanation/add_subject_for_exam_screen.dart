...
class AddSubjectForExamScreen extends StatefulWidget {
  const AddSubjectForExamScreen({super.key});

  @override
  State<AddSubjectForExamScreen> createState() => _AddSubjectForExamScreenState();
}

class _AddSubjectForExamScreenState extends State<AddSubjectForExamScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Add Subject For Exam",style: TextStyle(color: Colors.blueAccent),)
      ),
      body: Padding(
