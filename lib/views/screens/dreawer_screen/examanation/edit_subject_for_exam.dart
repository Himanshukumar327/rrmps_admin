...
class EditSubjectForExamScreen extends StatefulWidget {
  const EditSubjectForExamScreen({super.key});

  @override
  State<EditSubjectForExamScreen> createState() => _EditSubjectForExamScreenState();
}

class _EditSubjectForExamScreenState extends State<EditSubjectForExamScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Edit Subject For Exam",style: TextStyle(color: Colors.blueAccent),)
      ),
      body: Padding(
