...
class CoScholasticScreen extends StatefulWidget {
  ...
  @override
  CoScholasticScreenState createState() => CoScholasticScreenState();
}

class CoScholasticScreenState extends State<CoScholasticScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Co-Scholastic",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),)),
      body: Padding(
