...
class UpdateMarksScreen extends StatefulWidget {
  const UpdateMarksScreen({super.key});

  @override
  UpdateMarksScreenState createState() => UpdateMarksScreenState();
}

class UpdateMarksScreenState extends State<UpdateMarksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Update Marks",style: TextStyle(color: Colors.blueAccent,
