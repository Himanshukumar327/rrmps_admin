...
class CoCoScholasticScreen extends StatefulWidget {
  const CoCoScholasticScreen({super.key});

  @override
  CoCoScholasticScreenState createState() => CoCoScholasticScreenState();
}

class CoCoScholasticScreenState extends State<CoCoScholasticScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
          ...
          title: Text("Co-Co-Scholastic",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),)),
      body: Padding(
