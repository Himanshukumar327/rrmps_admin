...
class UpdateCoScholasticScreen extends StatefulWidget {
  const UpdateCoScholasticScreen({super.key});

  @override
  UpdateCoScholasticScreenState createState() => UpdateCoScholasticScreenState();
}

class UpdateCoScholasticScreenState extends State<UpdateCoScholasticScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Update Co-Scholastic",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),)),
      body: Padding(
