...
class ViewReportCard extends StatefulWidget {
  ...
  @override
  ViewReportCardState createState() => ViewReportCardState();
}

class ViewReportCardState extends State<ViewReportCard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Report Card Screen",style: TextStyle(color: Colors.blueAccent,
